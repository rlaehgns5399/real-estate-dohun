 ...
 *
 * 지목은 거르지 않는다. 이 단지 지번(상일동 28)은 '대' 37건에 '답'이 5건 섞이는데,
 * 토지정리가 아직 안 끝나 지적공부상 지목이 예전 것으로 남아 있을 뿐 둘 다 같은
 * 아파트 거래다. 실제로 이용목적은 42건 전부 '주거용'이고, 강동구에서 지목이 섞인
 * 아파트 필지는 넷뿐인데(상일동 28, 강일동 72·66·114) 전부 고덕강일지구 신축이다.
 * 기성 단지는 예외 없이 '대' 하나로만 나온다.
 */
